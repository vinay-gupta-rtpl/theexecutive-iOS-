...
#.xcodeproj filename
projectFile='DelamiEcommerceApp.xcodeproj';
#readParameter projectFile 'sonar.swift.project'
workspaceFile='DelamiEcommerceApp.xcworkspace';
#readParameter workspaceFile 'sonar.swift.workspace'
...
srcDirs='.';
#readParameter srcDirs 'sonar.sources'
# The name of your application scheme in Xcode
appScheme='QAT';
#readParameter appScheme 'sonar.swift.appScheme'
# The app configuration to use for the build
appConfiguration='';
#readParameter appConfiguration 'sonar.swift.appConfiguration'
# The name of your test scheme in Xcode
#testScheme='CCMUnitTest';
#readParameter testScheme 'sonar.swift.testScheme'
# The name of your binary file (application)
binaryName='';
#readParameter binaryName 'sonar.swift.appName'
# Get the path of plist file
#plistFile='/Users/kritika/Desktop/CCM'
plistFile='/Users/jogendarsingh/Documents/Jenkins/workspace/DelamiBrands_iOS'
#`xcodebuild -showBuildSettings -project "${projectFile}" | grep -i 'PRODUCT_SETTINGS_PATH' -m 1 | sed 's/[ ]*PRODUCT_SETTINGS_PATH = //'`
# Number version from plist if no sonar.projectVersion
numVerionFromPlist='1.0'
#`defaults read ${plistFile} CFBundleShortVersionString`

# Read destination simulator
destinationSimulator='platform=iOS Simulator,name=iPhone SE,OS=11.4';
#readParameter destinationSimulator 'sonar.swift.simulator'
