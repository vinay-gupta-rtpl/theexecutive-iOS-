...
class CITreeViewController: NSObject {
    ...
    func addIndexPath(with indexPath: IndexPath) {
    ...
    func expandRows(atIndexPath indexPath: IndexPath, with selectedTreeViewNode: CITreeViewNode) {
        ...
        for item in children! {
            indexPathsArray.append(IndexPath(row: row, section: indexPath.section))
    ...
    func collapseAllRows(section: Int) -> CITreeViewNode? {
        indexPathsArray = [IndexPath]()
